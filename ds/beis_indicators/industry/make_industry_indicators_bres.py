...
ind_cult = make_indicator(bres_cult,
               ...
               geo_type = 'nuts2', geo_spec=2013,geo_var='geo_cd',decimals=0)

save_indicator(ind_cult,f'{project_dir}/data/processed/industry','employment_culture_entertainment_recreation', 'nuts2')
...
ind_compl = make_indicator(compl.loc[(compl['source']=='IDBR')&(compl['sector_type']=='cluster_name')],
              {'eci':'economic_complexity_index'},year_var='year',geo_type = 'nuts2',geo_spec=2013,geo_var='geo_cd',
              decimals=4)

save_indicator(ind_compl,f'{project_dir}/data/processed/industry','economic_complexity_index', 'nuts2')
