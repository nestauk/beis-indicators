<script>
	...
	import ArrowLeftCircle from '@svizzle/ui/src/icons/feather/ArrowLeftCircle.svelte';
	import ArrowRightCircle from '@svizzle/ui/src/icons/feather/ArrowRightCircle.svelte';
...
<dialog class={$_screen?.classes} style='--gap: {gap}px'>
	<nav class='resets'>
		<div
			class='text'
