...
export const toolName = 'BEIS/Nesta R&D dashboard';
export const toolLongName = 'BEIS/Nesta Research & Development spatial data tool';
export const contactEmail = 'dataanalytics@nesta.org.uk';

/* navigation */

export const hrefBase = '/indicators';
export const userTestingUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSekqhPhm4VNDdQNmpbE0EjTQj8zruLw8mIyqJH5hV9z-Dytbw/viewform?embedded=true';
...
export const urlBases = {
    ...
    preview: 'https://beis-indicators-dev.netlify.app',
    // production: '',
};
