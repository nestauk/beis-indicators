...
export const name = `beis_indicators_${version.replace(/\./ug, '_')}`;
export const allIndicatorsCsvName = `${name}.csv`;
export const allIndicatorsCSVUrl = `/data/${allIndicatorsCsvName}`;
export const zipName = `${name}.zip`;
...
const steps = inclusiveRange([0, 1, 0.2]).reverse();
const colorRange = _.map(steps, interpolateRdYlBu);
